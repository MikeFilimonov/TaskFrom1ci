...
Procedure OnWrite(Cancel, Replacing)
	...
	|	LineNumber, RegisterRecordsSerialNumbersChange.Products
	|	AS Products, RegisterRecordsSerialNumbersChange.Characteristic
	...
	|		AS LineNumber, RegisterRecordsSerialNumbersBeforeWrite.Products
	|		AS Products, RegisterRecordsSerialNumbersBeforeWrite.Characteristic
