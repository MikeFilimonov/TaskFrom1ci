...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	SalesOrderAdditionalAttributes = PropertiesManagement.GetListOfProperties(Documents.SalesOrder.EmptyRef(), True, False);
	InvoiceAdditionalAttributes = PropertiesManagement.GetListOfProperties(Documents.Quote.EmptyRef(), True, False);
