...
Procedure SetScheduledJobParameters(ScheduledJobObject, JobSchedule, CurrentObject)
	...
	ScheduledJobDescription = NStr("en = 'Exchanging using scenario: %1'");
...
Procedure WriteScheduledJob(Cancel, ScheduledJobObject)
	...
	Except
		...
		MessageString = NStr("en = 'An error occurred when saving the exchange schedule. Error description: %1'");
