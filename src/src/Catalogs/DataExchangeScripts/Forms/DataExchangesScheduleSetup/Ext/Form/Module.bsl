...
Procedure RunScript(Command)
	...
	Message = NStr("en = 'Data is being synchronized using script ""%1""...'");
	...
	If Cancel Then
		Message = NStr("en = 'Data synchronization scenario completed with errors.'");
		Picture = PictureLib.Error32;
	Else
		Message = NStr("en = 'Synchronization scenario is completed successfully.'");
		Picture = Undefined;
	EndIf;
