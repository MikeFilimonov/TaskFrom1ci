...
Procedure OnOpen(Cancel)
	...
	ElsIf ValueIsFilled(Object.RequestStatus)
	        AND Object.RequestStatus
	           <> PredefinedValue("Enum.CertificateIssueRequestStatus.Executed") Then
...
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
	...
	For Each KeyAndValue In AttributesParameters Do
		...
		MessageText = StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'The ""%1"" field is not filled in.'"), Items[AttributeName].Title);
...
Procedure CheckCertificate(Command)
	...
	If Not ValueIsFilled(Object.Ref) Then
		ShowMessageBox(, NStr("en = 'ElectronicSignature has not been recorded yet.'"));
		Return;
	EndIf;
...
Procedure CertificateRevoked(Command)
	...
	If Object.Revoked Then
		ShowMessageBox(, NStr("en = 'After writing, callback cannot be canceled.'"));
	EndIf;
...
Procedure OnCreateAtServerOnReadAtServer()
	...
	If ValueIsFilled(Object.RequestStatus) Then
		If Object.RequestStatus = Enums.CertificateIssueRequestStatus.Executed Then
	...
	If TypeOf(CertificateBinaryData) = Type("BinaryData") Then
		...
		EndIf;
		DigitalSignatureClientServer.FillCertificateDataDescription(CertificateDataDescription, ElectronicSignature);
	Else
		CertificateAddress = "";
	...
	If Not ValueIsFilled(CertificateAddress) Then
		Return; // ElectronicSignature = Undefined.
	EndIf;
	...
	DigitalSignatureService.BeforeEditKeyCertificate(
		Object.Ref, ElectronicSignature, AttributesParameters);
