...
Function GeneratePrintFormProductsCodes(ObjectsArray, PrintObjects, PrintParameters)
	...
	Template = PrintManagement.PrintedFormsTemplate("Catalog.ExchangeWithOfflinePeripheralsRules.PF_MXL_ProductCodes");
	FirstDocument = True;
	...
	For Each Object In ObjectsArray Do
		...
		TemplateArea.Parameters.HeaderText = NStr("en = 'Goods codes'");
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en = 'Goods codes'");
