...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If CommonUse.SubsystemExists("StandardSubsystems.DigitalSignature") Then
		...
		ExtensionForEncryptedFiles = ModuleDigitalSignatureClientServer.PersonalSettingsTip(
...
Procedure OnOpen(Cancel)
	...
	#If WebClient Then
		ShowMessageBox(, NStr("en = 'Directory export is not supported in Web client.'"));
		Cancel = True;
		Return;
	#EndIf
...
Procedure SaveFolder()
	...
	If Not ExportDirectory.Exist() Then
		...
		Except
			ErrorText = NStr("en = 'Cannot create an export folder:'");
