...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Object.Ref.IsEmpty() Then
		OpenError = NStr("en = 'You can create report option only from the report form'");
		Return;
	EndIf;
...
Procedure BeforeWriteAtServer(Cancel, CurrentObject, WriteParameters)
	// Record of the properties associated with the predefined report option.
...
Procedure DescriptionStartChoice(Item, ChoiceData, StandardProcessing)
	...
	ReportsVariantsClient.EditMultilineText(ThisObject, Item.EditText, Object, "Definition", NStr("en = 'Definitions'"));
EndProcedure
