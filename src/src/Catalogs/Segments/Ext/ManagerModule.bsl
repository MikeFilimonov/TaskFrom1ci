...
Function GetAvailableFilterRules() Export
	...
	While Selection.Next() Do
		...
		If Selection.Type = Enums.ContactInformationTypes.Address Then
			...
			NewRule = RuleAddress.Rows.Add();
			NewRule.Name = "ContactInformationTypestate";
			NewRule.DynamicRuleKey = Selection.Ref;
			NewRule.IsFolder = False;
			NewRule.MultipleUse = False;
	...
	GroupAdditional.Presentation = NStr("en = 'Event clarifications'");
	GroupAdditional.IsFolder = True;
	
	NewRule = GroupAdditional.Rows.Add();
	NewRule.Name = "EventsState";
	NewRule.Presentation = NStr("en = 'Event state'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	NewRule.ValueProperties.Insert("TypeRestriction", New TypeDescription("CatalogRef.JobAndEventStatuses"));
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
	AddComparisonTypes(NewRule, "Equal,NotEqual,InList,NotInList");
	...
	GroupOrders.Presentation = NStr("en = 'Sales orders (remoteness, quantity)'");
	...
	RuleOrdersQuantity.Presentation = NStr("en = 'Number of orders'");
	...
	GroupAdditional.Name = "SalesOrdersAdditionally";
	GroupAdditional.Presentation = NStr("en = 'Clarifications of sales orders'");
	GroupAdditional.IsFolder = True;
	
	NewRule = GroupAdditional.Rows.Add();
	NewRule.Name = "SalesOrdersOrderState";
	NewRule.Presentation = NStr("en = 'State of sales orders'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	NewRule.ValueProperties.Insert("TypeRestriction", New TypeDescription("CatalogRef.SalesOrderStatuses"));
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
	AddComparisonTypes(NewRule, "Equal,NotEqual,InList,NotInList");
	...
	Account_sGroup.Presentation = NStr("en = 'Proforma invoices (issue date, quantity)'");
	...
	RuleAccountsQuantity.Presentation = NStr("en = 'Number of accounts'");
	...
	GroupSalesProducts.Presentation = NStr("en = 'Sales (products)'");
	GroupSalesProducts.IsFolder = True;
	
	NewRule = GroupSalesProducts.Rows.Add();
	NewRule.Name = "SalesProductsProducts";
	NewRule.Presentation = NStr("en = 'ProductAndServices'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	...
	NewRule.Presentation = NStr("en = 'Product group'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	NewRule.ValueProperties.Insert("TypeRestriction", New TypeDescription("CatalogRef.Products"));
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Folders);
	...
	GroupAdditional = GroupSalesProducts.Rows.Add();
	GroupAdditional.Name = "SalesProductsAdditionally";
	GroupAdditional.Presentation = NStr("en = 'Sales clarification by products'");
	GroupAdditional.IsFolder = True;
	
	NewRule = GroupAdditional.Rows.Add();
	NewRule.Name = "SalesProductsPeriod";
	NewRule.Presentation = NStr("en = 'For the period (sales by products)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	NewRule.ValueProperties.Insert("TypeRestriction", TypeDescriptionStandardPeriod);
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
	...
	GroupSalesIncome.Presentation = NStr("en = 'Sales (revenue, profit)'");
	GroupSalesIncome.IsFolder = True;
	
	NewRule = GroupSalesIncome.Rows.Add();
	NewRule.Name = "SalesIncomeIncome";
	NewRule.Presentation = NStr("en = 'Revenue (man. currency)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = True;
	...
	GroupAdditional.Presentation = NStr("en = 'Clarifications of revenue from sales'");
	GroupAdditional.IsFolder = True;
	
	NewRule = GroupAdditional.Rows.Add();
	NewRule.Name = "SalesIncomePeriod";
	NewRule.Presentation = NStr("en = 'For a period (revenue from sales)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = False;
	NewRule.ValueProperties.Insert("TypeRestriction", TypeDescriptionStandardPeriod);
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
	...
	NewRule.Presentation = NStr("en = 'Customer overdue period (days)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = True;
	...
	NewRule.Presentation = NStr("en = 'Amount of debt to supplier (man. currency)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = True;
	NewRule.ValueProperties.Insert("TypeRestriction", CurrencyTypeDescription);
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
	...
	NewRule.Presentation = NStr("en = 'Supplier overdue period (days)'");
	NewRule.IsFolder = False;
	NewRule.MultipleUse = True;
	NewRule.ValueProperties.Insert("TypeRestriction", New TypeDescription("Number"));
	NewRule.ValueProperties.Insert("ChoiceFoldersAndItems", FoldersAndItems.Auto);
...
Function GenerateQueryOnRules(Segment) Export
	...
	While RulesSelection.Next() Do
		...
		ElsIf Left(RulesSelection.Name, 17) = "SalesOrders" Then
			...
			ElsIf RulesSelection.Name = "SalesOrdersQuantityPeriod" Then
				If ValueIsFilled(RuleSettings.Value.StartDate) Then
					InsertedQueryFilter.Add(ComparisonCondition("SalesOrder.Date", DataCompositionComparisonType.GreaterOrEqual, RulesSelection.Name + "Begin"));
					Query.SetParameter(RulesSelection.Name + "Begin", RuleSettings.Value.StartDate);
				EndIf;
				If ValueIsFilled(RuleSettings.Value.EndDate) Then
					InsertedQueryFilter.Add(ComparisonCondition("SalesOrder.Date", DataCompositionComparisonType.LessOrEqual, RulesSelection.Name + "End"));
					Query.SetParameter(RulesSelection.Name + "End",  RuleSettings.Value.EndDate);
				EndIf;
			ElsIf RulesSelection.Name = "SalesOrdersOrderState" Then
				InsertedQueryFilter.Add(ComparisonCondition("SalesOrder.OrderState", RuleSettings.ComparisonType, RulesSelection.Name));
				Query.SetParameter(RulesSelection.Name, RuleSettings.Value);
			EndIf;
		...
		ElsIf Left(RulesSelection.Name, 13) = "InvoicesForPayment" Then
			...
			ElsIf RulesSelection.Name = "InvoicesForPaymentQuantityPeriod" Then
				If ValueIsFilled(RuleSettings.Value.StartDate) Then
					InsertedQueryFilter.Add(ComparisonCondition("Quote.Date", DataCompositionComparisonType.GreaterOrEqual, RulesSelection.Name + "Begin"));
					Query.SetParameter(RulesSelection.Name + "Begin", RuleSettings.Value.StartDate);
				EndIf;
				If ValueIsFilled(RuleSettings.Value.EndDate) Then
					InsertedQueryFilter.Add(ComparisonCondition("Quote.Date", DataCompositionComparisonType.LessOrEqual, RulesSelection.Name + "End"));
					Query.SetParameter(RulesSelection.Name + "End",  RuleSettings.Value.EndDate);
				EndIf;
			EndIf;
			
		ElsIf Left(RulesSelection.Name, 19) = "SalesProducts" Then
			...
			If NewSource = Undefined Then
				...
				|		WHEN Sales.Document REFS Document.SubcontractorReportIssued
				|			THEN CAST(Sales.Document AS Document.SubcontractorReportIssued).Counterparty
				...
				NewSource.Joins.Clear();
				Operator.Sources[0].Joins.Add("SalesProducts", "Counterparties.Ref = SalesRroductsAndServices.Counterparty");
				Operator.Sources[0].Joins[0].JoinType = QuerySchemaJoinType.Inner;
			...
			If RulesSelection.Name = "SalesProductsProducts" Then
				InsertedQueryFilter.Add(ComparisonCondition("Sales.Products", RuleSettings.ComparisonType, RulesSelection.Name));
				Query.SetParameter(RulesSelection.Name, RuleSettings.Value);
			ElsIf RulesSelection.Name = "SalesProductsProductsGroup" Then
				InsertedQueryFilter.Add(ComparisonCondition("Sales.Products.Parent", RuleSettings.ComparisonType, RulesSelection.Name));
				Query.SetParameter(RulesSelection.Name, RuleSettings.Value);
			ElsIf RulesSelection.Name = "SalesProductsProductsCategory" Then
				InsertedQueryFilter.Add(ComparisonCondition("Sales.Products.ProductsCategory", RuleSettings.ComparisonType, RulesSelection.Name));
				Query.SetParameter(RulesSelection.Name, RuleSettings.Value);
		...
		ElsIf Left(RulesSelection.Name, 14) = "SalesIncome" Then
			...
			If NewSource = Undefined Then
				...
				|		WHEN SalesTurnovers.Document REFS Document.SubcontractorReportIssued
				|			THEN CAST(SalesTurnovers.Document AS Document.SubcontractorReportIssued).Counterparty
...
Procedure AddComparisonTypes(Rule, AddedComparisonsKinds, DefaultTypeNumber = 1)
	...
	For Each KindInString In TypesArray Do
		...
		ElsIf KindInString = "InList" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.InList,		 NStr("en = 'In the list'"));
		...
		ElsIf KindInString = "NotInHierarchy" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.NotInHierarchy,	 NStr("en = 'Not in group'"));
		ElsIf KindInString = "Filled" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.Filled,		 NStr("en = 'filled in'"));
		ElsIf KindInString = "NotFilled" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.NotFilled,	 NStr("en = 'Not filled in'"));
		...
		ElsIf KindInString = "NotBeginsWith" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.NotBeginsWith,	 NStr("en = 'Does not begin with'"));
		...
		ElsIf KindInString = "NotContains" Then
			Rule.AvailableComparisonTypes.Add(DataCompositionComparisonType.NotContains,	 NStr("en = 'Does not contain'"));
		EndIf;
	EndDo;
