...
Function UserTransferToGroup(UserArray, NewGroupOwner)
	...
	Return UsersService.GeneratingMessageToUser(
		DisplacedUsersArray, NewGroupOwner, False, ArrayIsNotDisplacedUsers);
...
Function AnExtendedFormOfSelectionOptions()
	...
	UserGroupsMembers = Object.Content.Unload(, "User");
	
	For Each Item In UserGroupsMembers Do
	...
	FormHeaderSelection = NStr("en = 'Select participants of user group'");
