...
Procedure OnWrite(Cancel)
	...
	If PropertiesManagementService.ValueTypeContainsPropertiesValues(ValueType) Then
		...
		While Selection.Next() Do
			...
			If ValueType.ContainsType(Type("CatalogRef.AdditionalValues"))
			   AND Not Selection.ValueType.ContainsType(Type("CatalogRef.AdditionalValues")) Then
			...
			ElsIf ValueType.ContainsType(Type("CatalogRef.AdditionalValuesHierarchy"))
			        AND Not Selection.ValueType.ContainsType(Type("CatalogRef.AdditionalValuesHierarchy")) Then
