...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.ObjectFill Then
		ThisIsAppointedDataProcessors	= True;
		Title							= NStr("en = 'Object population commands'");
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.Report Then
		ThisIsAppointedDataProcessors	= True;
		AreReports						= True;
		Title							= NStr("en = 'Reports'");
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.PrintForm Then
		ThisIsAppointedDataProcessors	= True;
		Title = NStr("en = 'Additional print forms'");
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.CreatingLinkedObjects Then
		ThisIsAppointedDataProcessors	= True;
		Title							= NStr("en = 'Commands for linked object creation'");
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.AdditionalInformationProcessor Then
	...
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.AdditionalReport Then
		ThisIsGlobalDataProcessors	= True;
		AreReports					= True;
		Title						= StringFunctionsClientServer.SubstituteParametersInString(
										NStr("en = 'Additional reports (%1)'"), 
										AdditionalReportsAndDataProcessors.PresentationOfSection(SectionReference));
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.BankExchangeProcessor Then
		ThisIsGlobalDataProcessors	= True;
		Title						= StringFunctionsClientServer.SubstituteParametersInString(
										NStr("en = 'Bank exchange processor (%1)'"), 
										AdditionalReportsAndDataProcessors.PresentationOfSection(SectionReference));
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.ExchangeRatesImportProcessor Then
		ThisIsGlobalDataProcessors	= True;
		Title						= StringFunctionsClientServer.SubstituteParametersInString(
										NStr("en = 'Exchange rates import processor (%1)'"), 
										AdditionalReportsAndDataProcessors.PresentationOfSection(SectionReference));
	ElsIf KindOfDataProcessors = Enums.AdditionalReportsAndDataProcessorsTypes.SMSProvider Then
		ThisIsGlobalDataProcessors	= True;
		Title						= StringFunctionsClientServer.SubstituteParametersInString(
										NStr("en = 'SMS provider (%1)'"), 
										AdditionalReportsAndDataProcessors.PresentationOfSection(SectionReference));
	EndIf;
...
Procedure CustomizeList(Command)
	...
	Open.Name = "CommonForm.SetUpMyReportsAndDataProcessors";
...
Procedure RunDataProcessorByParameters()
	...
	ElsIf KindOfDataProcessors = PredefinedValue("Enum.AdditionalReportsAndDataProcessorsTypes.PrintForm")
	...
	ElsIf DataProcessorData.StartVariant = PredefinedValue("Enum.AdditionalDataProcessorsCallMethods.CallOfServerMethod")
		...
		Items.ExplanatoryDecoration.Title = StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Executing the ""%1"" command...'"),
...
Function ExecuteProcessingServerMethodAtServer(ServerCallParameters)
	...
	Try
		BackgroundJobResult = LongActions.ExecuteInBackground(
			...
			NStr("en = 'Additional reports and data processors: Running server method of data processor'"));
