...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(OfflineWorkplace) Then
		Raise NStr("en = 'An offline work place is not specified.'");
	EndIf;
...
Procedure LongOperationIdleHandler()
	...
	Except
		...
		LongAction = False;
		SkipBack();
		ShowMessageBox(,NStr("en = 'Errors occurred during the operation.'"));
...
#Region OverridablePart_ServiceProceduresAndFunctions
...
Procedure DeleteOfflineWorkplace(Cancel)
	...
	Result = LongActions.ExecuteInBackground(
					...
					NStr("en = 'Deletion of offline work place'"));
...
#Region OverridablePart_TransitionEventsHandlers
...
#Region OverridablePart_InitializeAsistantTransitions
