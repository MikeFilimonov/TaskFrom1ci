...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Else
		SupportText = NStr("en = 'Executing the command...'");
	EndIf;
	...
	Try
		...
		AssignmentResult = LongActions.ExecuteInBackground(
			...
			StringFunctionsClientServer.SubstituteParametersInString(
				NStr("en = 'Running additional report or data processor ""%1"", command name ""%2""'"),
...
Procedure Cancel(Command)
	QuestionText = NStr("en = 'Long action is still in process.'");
