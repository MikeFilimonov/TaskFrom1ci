...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Users.InfobaseUserWithFullAccess() Then
		...
		Raise NStr("en = 'Insufficient rights to set up offline work.'");
		
	ElsIf Not OfflineWorkService.OfflineWorkSupported() Then
		
		Raise NStr("en = 'Offline work is not available in the application.'");
...
Procedure HowToSetOfflineWorkplace(Command)
	...
	FormParameters.Insert("Title", NStr("en = 'How to configure an offline work place'"));
...
Procedure DisableIndividualWorkplace(DeactivatebleOfflineWorkplace)
	...
	OpenForm("CommonForm.DisableOfflineWorkPlace", FormParameters, ThisObject, DeactivatebleOfflineWorkplace);
