...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not OfflineWorkService.ThisIsOfflineWorkplace() Then
		Raise NStr("en = 'This infobase is not an offline work place.'");
	EndIf;
...
Procedure OnChangeScheduleDataSynchronization()
	...
	Items.DataSynchronizationScheduleVariant.ChoiceList.Add(3, NStr("en = 'Every day at 10:00 a.m., except for Saturdays and Sundays'"));
