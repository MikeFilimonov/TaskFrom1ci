...
Procedure ChoiceProcessing(ValueSelected, ChoiceSource)
	...
	If Upper(ChoiceSource.FormName) = Upper("CommonForm.ProxyServerAdditionalSettings") Then
...
&AtClient
Procedure ProxyServerAdditionalSettings(Command)
	...
	OpenForm("CommonForm.ProxyServerAdditionalSettings", FormParameters, ThisObject);
