...
// SubsystemsWithCIOnly - Boolean - identifier of only those subsystems in the selection list which are included in the
//                                  command interface (special for SSL implementation assistant).
...
Procedure MetadataObjectTreeFill()
	...
	CollectionsOfMetadataObjects_NewRow("SessionParameters",              NStr("en = 'Session parameters'"),               39, 40, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("EventSubscriptions",            NStr("en = 'Subscription to events'"),            47, 48, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("FunctionalOptionsParameters", NStr("en = 'Functional option parameters'"), 53, 54, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SettingsStorages",            NStr("en = 'Setting storage'"),             55, 56, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonForms",                   NStr("en = 'Common forms'"),                    57, 58, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonCommands",                 NStr("en = 'Common commands'"),                  59, 60, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("DocumentJournals",            NStr("en = 'Document logs'"),             PictureLib.DocumentJournal,       PictureLib.DocumentJournal,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Enums",                 NStr("en = 'Transfers'"),                   PictureLib.Enum,           PictureLib.Enum,                 False, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("DataProcessors",                    NStr("en = 'Data processors'"),                      PictureLib.DataProcessor,              PictureLib.DataProcessor,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCharacteristicTypes",      NStr("en = 'Charts of characteristic types'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("ChartsOfCalculationTypes",            NStr("en = 'Charts of characteristic types'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
