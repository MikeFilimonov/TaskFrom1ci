...
Procedure BeforeClose(Cancel, Exit, WarningText, StandardProcessing)	
	...
	CommonUseClient.ShowFormClosingConfirmation(Handler, Cancel, Exit, QuestionText);
...
Function FillTreeOfDataProcessors(UserCommands, NameAttributeItemsOfTree)
	...
	|		LEFT JOIN InformationRegister.UserAccessToDataProcessors AS QuickAccess
	...
	If Not UserCommands Then
		QueryText = StrReplace(QueryText, "LEFT JOIN InformationRegister.UserAccessToDataProcessors AS QuickAccess", "");
...
#Region WorkWithTheRegisterUserAccessToDataProcessors
