...
Function PostServer(DocumentRef)
	...
	Except
		Message = New UserMessage();
		Message.Text = NStr("en = 'Cannot lock the document.'");
		Message.Message();
	EndTry; 
...
Procedure Post(Button)
	...
	Except
		...
		Message = New UserMessage();
		Message.Text = NStr("en = 'Cannot post the %Document% document.'");;
...
Procedure UndoPosting(Button)
	...
	Except
		...
		Message = New UserMessage();
		Message.Text = NStr("en = 'Cannot unpost the %Document% document.'");;
		Message.Text = StrReplace(Message.Text, "%Document%", Items.DocumentsTree.CurrentData.DocumentPresentation);
		Message.Message();
...
Procedure SetDeletionMark(Button)
	...
	Except
		...
		Message = New UserMessage();
		Message.Text = NStr("en = 'Cannot mark the %Document% document for deletion.'");;
