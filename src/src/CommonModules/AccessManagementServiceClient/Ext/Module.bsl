...
#Region EventHandlersOfFormTableAccessValues
...
Procedure AccessValueChoiceProcessing(Form, Item, ValueSelected, StandardProcessing) Export
	...
	If ValueSelected = Type("CatalogRef.Users") OR
	     ValueSelected = Type("CatalogRef.UserGroups") Then
	...
	ElsIf ValueSelected = Type("CatalogRef.ExternalUsers") OR
	          ValueSelected = Type("CatalogRef.ExternalUserGroups") Then
...
#Region EventHandlersOfFormTableAccessKinds
