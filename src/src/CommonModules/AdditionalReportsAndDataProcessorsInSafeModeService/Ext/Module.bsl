...
Function SecurityProfileTemplateName(Val ExternalModule) Export
	...
	Kind = CommonUse.ObjectAttributeValue(ExternalModule, "Type");
	If Kind = Enums.AdditionalReportsAndDataProcessorsTypes.Report Or Kind = Enums.AdditionalReportsAndDataProcessorsTypes.AdditionalReport Then
...
Function ExternalModuleContainerDictionary() Export
	...
	Result.Insert("Nominative", NStr("en = 'Additional report of data processor'"));
	Result.Insert("Genitive", NStr("en = 'Additional report of data processor'"));
...
Function QueriesOnPermissionsForAdditionalDataProcessors() Export
	...
	While Selection.Next() Do
		...
		NewQueries = QueriesOnPermissionsForAdditionalDataProcessor(Object, Object.permissions.Unload());
...
Function QueriesOnPermissionsForAdditionalDataProcessor(Val Object, Val PermissionsInData, Val DeletionMark = Undefined) Export
	...
	For Each ScriptStep In Script Do
		...
		Else
			...
			Raise StringFunctionsClientServer.SubstituteParametersInString(
				NStr("en = 'Unknown action kind for script stage: %1'"),
		...
		For Each MethodParameter In MethodParameters Do
			...
			Else
				...
				Raise StringFunctionsClientServer.SubstituteParametersInString(
					NStr("en = 'Unknown parameter for script stage: %1'"),
...
Function PermissionIsNotGrantedTextOfException(Val SessionKey, Val TypeRequiredPermissions)
	...
	Return StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Permission (%2)%3 is not provided for additional report or data processor %1.'"),
