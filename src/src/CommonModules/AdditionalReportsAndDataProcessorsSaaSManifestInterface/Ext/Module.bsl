...
//  AdditionalReportsAndDataProcessorsTypes values XDTO-type {http://www.1c.ru/1CFresh/ApplicationExtensions/Core/a.b.c.d}ExtensionCategory
//
Function DictionaryAdditionalReportAndDataProcessorTypes() Export
	
	Dictionary = New Structure();
	Manager = Enums.AdditionalReportsAndDataProcessorsTypes;
	...
	Dictionary.Insert("ObjectFill", Manager.ObjectFill);
