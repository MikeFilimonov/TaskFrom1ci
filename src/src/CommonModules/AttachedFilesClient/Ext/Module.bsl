...
// in the user working directory while looking for the file in the working directory and offers to open the existing
// file or get a file from the server. If the file is opened for editing, it opens the file in the
...
//                                           can be passed to make the process faster if the properties had been
//                                           received to the client from the server.
//
...
//         * FileData    - Structure - properties of the file which
//                                        can be passed to make the process faster if the properties had been received
