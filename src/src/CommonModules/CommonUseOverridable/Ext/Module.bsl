...
//
// Description:
//   The Objects versioning and Properties subsystems are set for the Products implementation document.
...
Procedure OnAddExceptionsSearchLinks(RefsSearchExceptions) Export
	...
	// "Technology-generated" register CounterpartiesDuplicatesPresence is cleared in the BeforeRemoval handler of the
	// Counterparties catalog object module
	RefsSearchExceptions.Add(Metadata.InformationRegisters.CounterpartyDuplicates);
...
Procedure OnDefiningGeneralParametersBasicFunctionality(CommonParameters) Export
	...
	CommonParameters.Insert("FormNamePersonalSettings",			"CommonForm.PersonalSettingsTip");
...
//   options can define the filters conditions by the register measurements. They will be applied during reading the
//   value of this functional option.
//
// Parameters:
...
//
Function RecordSetByType(MetadataObject) Export
