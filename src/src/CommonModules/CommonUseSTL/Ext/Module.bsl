...
Function MetadataObjectDependence(Val MetadataObject) Export
	...
	Properties = ConfigurationModelObjectProperties(CommonUseSTLReUse.ConfigurationDataModelDescription(), MetadataObject);
	Return Properties.SubordinateDocumentStructure;
...
//                                    kind which can
//                         be used for the AccessRight function(),  * Interactive - Boolean, a flag that shows that the
//                         right restricts the option to execute interactive operations, * Reading - Boolean, a check
//                         box that the right provides or implies the possibility of reading the data of set metadata
//                         object, * Change - Boolean, a check box that the right provides or implies the possibility
