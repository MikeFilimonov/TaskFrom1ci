...
Procedure FillModelByMetadataObject(Val ModelGroup, Val MetadataObject, Val Class)
	...
	ObjectDescription.Insert("SubordinateDocumentStructure", New Map());
	...
	FillModelByMetadataObjectDependencies(ObjectDescription.SubordinateDocumentStructure, MetadataObject, Class);
