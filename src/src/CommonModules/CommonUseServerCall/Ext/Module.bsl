...
//                 exception of the refs search specified during disassembling of the configuration will not be taken
//                 into account.
//
// Returns:
//  Boolean.
...
#Region FunctionsForWorkWithStyleColorsInTheClientCode
