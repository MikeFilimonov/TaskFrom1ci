...
//      ContactInformationKind - CatalogRef.ContactInformationTypes - used to determine unfilled field content
//
//  Returns:
...
Function LocalityAddressPartsStructure() Export
	...
	Result.Insert("State",	ItemAddressStructure(NStr("en = 'Region'"),	NStr("en = 'Address region'"),	"RFTerritorialEntity",	1));
	Result.Insert("Region",	ItemAddressStructure(NStr("en = 'District'"),	NStr("en = 'Address county'"),		"PrRayMO/Region",		3));
	Result.Insert("City",	ItemAddressStructure(NStr("en = 'City'"),		NStr("en = 'Address city'"),		"City",					4));
	Result.Insert("Settlement", ItemAddressStructure(NStr("en = 'Settlement'"),
		NStr("en = 'Settlement addresses'"), "Settlement",  6, True));
	Result.Insert("Street", ItemAddressStructure(NStr("en = 'Street'"),
		NStr("en = 'Address street'"), "Street", 7));
	Result.Insert("AdditionalItem", ItemAddressStructure(NStr("en = 'Additional item'"),
