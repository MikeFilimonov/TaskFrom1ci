...
Function XSLT_UniqueByListPresentation(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_UniqueByListPresentation();
...
Function XSLT_ValueTableDifferencesXML(Text1, Text2)
	Transformer = ContactInformationManagementServiceReUse.XSLT_ValueTableDifferencesXML();
...
Function XSLT_KeyValueStringToStructure(Val Text) 
	Transformer = ContactInformationManagementServiceReUse.XSLT_KeyValueStringToStructure();
...
Function XSLT_KeyValueStringToValueList(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_KeyValueStringToValueList();
	Return Transformer.TransformFromString( XSLT_ParameterStringNode(Text) );
EndFunction
...
Function XSLT_ValueListToKeyValueString(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_ValueListToKeyValueString();
	Return Transformer.TransformFromString(Text);
EndFunction
...
Function XSLT_StructureToKeyValueString(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToKeyValueString();
	Return Transformer.TransformFromString(Text);
EndFunction
...
Function XSLT_ValueListToStructure(Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_ValueListToStructure();
	Return Transformer.TransformFromString(Text);
EndFunction
...
Function XSLT_StructureToValueList(Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToValueList();
	Return Transformer.TransformFromString(Text);
EndFunction
...
Function XSLT_MapToStructure(Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_MapToStructure();
	Return Transformer.TransformFromString(Text);
EndFunction
...
Function XSLT_ContactInformationXMLDifferenceInterpretation(Val Text, Val ContactInformationType) 
	Transformer = ContactInformationManagementServiceReUse.XSLT_ContactInformationXMLDifferenceInterpretation(
...
Function XSLT_StructureToWebPage(Val Text, Val Presentation = Undefined, Val Comment = Undefined)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToWebPage();
...
Function XSLT_StructureToPhone(Val Text, Val Presentation = Undefined, Val Comment = Undefined)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToPhone();
	Return XSLT_PresentationAndCommentControl(
...
Function XSLT_StructureToFax(Val Text, Val Presentation = Undefined, Val Comment = Undefined)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToFax();
	Return XSLT_PresentationAndCommentControl(
		Transformer.TransformFromString(Text),
		Presentation, Comment);
EndFunction
...
Function XSLT_StructureToOther(Val Text, Val Presentation = Undefined, Val Comment = Undefined)
	Transformer = ContactInformationManagementServiceReUse.XSLT_StructureToOther();
...
Function XSLT_DeleteDescriptionXML(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_DeleteDescriptionXML();
...
Function XSLT_ContactInformationTypeByXMLString(Val Text)
	Transformer = ContactInformationManagementServiceReUse.XSLT_ContactInformationTypeByXMLString();
	Return Transformer.TransformFromString(TrimL(Text));
EndFunction
