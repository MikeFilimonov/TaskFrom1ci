...
// Exports application data to the zip-archive from which they can be imported later into another infobase or data area
// with the help of the DataAreasExportImport.ImportCurrentDataAreaFromArchive() function
//
...
//  Later the data from the archive can be imported into another infobase or data area with the help of the
//  DataAreasExportImport.ImportCurrentDataAreaFromArchive() funtion
//
// Parameters:
//  StorageAddress - String, the address in the temporary storage in which it is required to place the zip-archive with
//                   the data.
//
...
//    Keys:
//      ImportedTypes - Array(MetadataObject) - the array of metadata objects, the data of which are required to be
//        imported from the archive. If the parameter value is set - all other data contained in the import file will
//        not be imported. If the parameter value is not set - all the data contained in the export file will be imported.
//      ImportUsers - Boolean - import the information on the infobase users, LoadUserSettings - Boolean, it is ignored
//                              if ImportUsers = False.
