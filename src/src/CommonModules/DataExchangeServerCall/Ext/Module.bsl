...
//                                                                         date of the last actual cache for the
//                                                                         exchange data subsystem.
//
// Parameters:
//  No.
// 
...
// At the time of this constant change all reused values for the data exchange subsystem become obsolete and require
...
#Region DataExchangeWithTheFullRights
