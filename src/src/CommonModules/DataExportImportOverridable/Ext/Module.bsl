...
//      module of a handler, exported procedure BeforeExportType()
...
//    import process. For more information, see comment to the application interface of
...
//          data import process. For more information, see comment to the application interface of
//          data processor DataExportImportContainerManager.
...
//          handler was called. Value that is passed to procedure BeforeObjectImport() as
...
Procedure WhenDataExportHandlersRegistration(HandlersTable) Export
	...
	HandlerLine.Handler            = CommonUse.CommonModule("DataExchangeEventsDrive");
	HandlerLine.BeforeObjectImport = True;
	
	HandlerLine = HandlersTable.Add();
	HandlerLine.MetadataObject      = Metadata.Catalogs.AutomaticDiscountTypes;
	HandlerLine.Handler            = CommonUse.CommonModule("DataExchangeEventsDrive");
	HandlerLine.BeforeObjectImport = True;
