...
//          The parameter is passed only on the call of handler procedures for which version higher than 1.0.0.1 is
...
Procedure BeforeExportType(Container, Serializer, MetadataObject, Cancel) Export
	...
	Else
		...
		Raise ServiceTechnologyIntegrationWithSSL.PlaceParametersIntoString(
			NStr("en = 'Metadata object %1 cannot be processed by handler DataExportImportSequencesLimits.BeforeObjectExport().'"),
