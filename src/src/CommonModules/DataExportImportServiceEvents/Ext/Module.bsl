...
Procedure OnAddOfficeEvent(ClientEvents, ServerEvents) Export
	...
	//        objects that are associated with the metadata object. If the True value is set - in the general module
	...
	//                                                                           process of data export. See more
	...
	//                     handler requires additional data export
  ...
  //                     handler requires additional data export
	...
	//          handler was called. Value that is passed to the BeforeObjectExport() procedure as the Object parameter
	//          value can be modified within the BeforeObjectExport() processor, made changes will be shown in the object
 ...
 //         Artifacts - Array(XDTOObject) - Set additional information logically
	...
	//        Cancel - Boolean. If you set True for the parameter in procedure BeforeObjectExport()- object export for
	//                 which the
	...
	//                        infobase that belongs to that metadata object. If the
	//      True value is set - in a general module of the handler, exported procedure AfterExportType() must be
	//      implemented that supports the following parameters:
	//        Container - DataProcessorObject.DataExportImportContainerManager - container manager that is used in the
	//                                                                           process of data export. See more
	//          the review to the application data processor interface DataExportImportContainerManager, 
	//        Serializer - XDTOSerializer, initiated with support of references abstracts execution. If a random exporting
	...
	//
	// Parameters:
	//  Container - DataProcessorObject.DataExportImportContainerManager - manager of a container that is used in the data
	//                                                                     import process.
	...
	//      that must be implemented in a handler, depend on
	//      the values settings of the value table following columns,
	//     BeforeMatchingRefs - Boolean, a flag showing that a handler is to be called before matching the references (in
	...
	//          handler was called. Value that is passed to procedure BeforeObjectImport() as the Object parameter value
	//          can be modified within the handler procedure BeforeObjectImport().
	...
	//        Cancel - Boolean. If you install this parameter value to True in the BeforeObjectImport() procedure- Import
	//                 of the data object will not be executed.
...
#Region InitializationOfEventsDuringDataExport
...
#Region InitializationOfEventsDuringDataImport
