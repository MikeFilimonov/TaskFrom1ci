...
//                         as it is returned by the ContactInformationInXML function of the ContactInformationManagement
//                         common module.
//
...
//                     Director, ChiefAccountant, Employee that shows who is currently selected by a user as certificate
//                     owner. For this owner it is required to fill out the Initials attributes, ...
...
//                           it is returned by the ContactInformationInXML function of the ContactInformationManagement
//                           common module.
//
...
// items and in other places where certificates are created and updated, for example, in the
// SelectCertificateForSigningAndDecrypting form. Exception call is allowed if you need to stop
// an action and to tell something the user, for example, when you try to create an item-copy of the certificate with a
// limited access.
//
// Parameters:
//  Refs     - CatalogRef.DigitalSignaturesAndEncryptionKeyCertificates - empty for a new item.
//
//  ElectronicSignature - CryptoCertificate - certificate, for which a catalog item is created or updated.
//
...
//
//  InputParameters  - Arbitrary - the AdditionalActionsParameters property value of the DataDescription parameter of
//                                 the Sign, Decrypt method of the DigitalSignatureClient common module.
//                      
...
//
Procedure OnCreatingFormCertificateCheck(ElectronicSignature, AdditionalChecks, AdditionalChecksParameters) Export
...
//                            in the OnCreateFormCertificateChecking procedure of the DigitalSignatureOverridable common
//                            module.
...
// initial value False
// 
Procedure OnAdditionalCertificateVerification(ElectronicSignature, Checking, CryptoManager, ErrorDescription, IsWarning) Export
