...
//
// Example: 
//   Objects.Insert(Metadata.Documents.SalesOrder.FullName(), "*"); defined// both functions.
...
Procedure WhenDefiningObjectsWithEditableAttributes(Objects) Export
	...
	Objects.Insert(Metadata.Catalogs.ObsoleteWorkOrderAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	Objects.Insert(Metadata.Catalogs.SalesOrderAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	...
	Objects.Insert(Metadata.Catalogs.StocktakingAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	...
	Objects.Insert(Metadata.Catalogs.Products.FullName(), "EditedAttributesInGroupDataProcessing");
	Objects.Insert(Metadata.Catalogs.ProductsAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	...
	Objects.Insert(Metadata.Catalogs.BillsOfMaterialsAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	Objects.Insert(Metadata.Catalogs.Countries.FullName(), "AttributesToSkipOnGroupProcessing");
	Objects.Insert(Metadata.Catalogs.DataExchangeScripts.FullName(), "NotEditableInGroupProcessingAttributes");
	Objects.Insert(Metadata.Catalogs.SupplierQuoteAttachedFiles.FullName(), "EditedAttributesInGroupDataProcessing");
	...
	Objects.Insert(Metadata.Catalogs.ShippingAddresses.FullName(), "EditedAttributesInGroupDataProcessing");
