...
#Region InformationAboutLibraryorConfiguration
...
//                                    defined by the order of modules addition in procedure WhenAddingSubsystems of
//                                    common module ConfigurationSubsystemsOverridable.
//
...
#Region HandlersOfInfobaseUpdate
...
//                UpdateResults.UpdateHandlersNewTable.
//
...
//   PutReleaseNotes - Boolean - If you set True, then the
...
Procedure AfterInformationBaseUpdate(Val PreviousVersion, Val CurrentVersion,
	...
	For Each Handler In EventHandlers Do
		...
		Handler.Module.AfterInformationBaseUpdate(PreviousVersion, CurrentVersion,
			ExecutedHandlers, PutReleaseNotes, ExclusiveMode);
	EndDo;
