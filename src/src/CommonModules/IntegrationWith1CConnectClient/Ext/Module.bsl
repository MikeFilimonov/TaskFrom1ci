...
Procedure Select1CConnectFile(ClosingAlert, PathToFile = "") Export
	...
	SuggestionText = NStr("en = 'To select 1C-Connect application you shall install the file work extension.'");
...
Procedure Select1CConnectFileAfterExtensionInstallation(Attached, AdditionalParameters) Export
	...
	Dialog.Title = NStr("en = 'Select the executable 1C-Connect file'");
	...
	Filter = NStr("en = 'connect.exe (*.exe)|*.exe'");
...
Procedure FilePresence1CConnect(ClosingAlert, Path)
	...
	FilePresence1CConnectAfterFileInitialization(CheckedFile, ClosingAlert);
EndProcedure

// Procedure continued (see above).
Procedure FilePresence1CConnectAfterFileInitialization(File, ClosingAlert)
...
Procedure Run1CConnect() Export
	...
	MessageText = NStr("en = 'To start 1C-Connect, you shall install the file work extension.'");
...
Procedure Run1CConnectAfterCheckingPathFromStorage(PathFromStorageIsCorrect, AdditionalParameters) Export
	...
	OpenForm("CommonForm.Select1CConnectExecutableFile");
