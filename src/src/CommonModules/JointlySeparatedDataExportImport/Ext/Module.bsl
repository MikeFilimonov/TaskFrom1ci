...
//          handler requires additional data export - You should use SerializerXDTO that is passed to
...
//          additional information logically connected inextricably with the object but not not being his part artifacts object). Artifacts should formed inside handler BeforeObjectExport() and added to the array passed as parameter values Artifacts. Each artifact must be the XDTOobject for which type, as the base type, abstract XDTOtype is used {http://www.1c.ru/1cFresh/Data/Dump/1.0.2.1} Artefact.
