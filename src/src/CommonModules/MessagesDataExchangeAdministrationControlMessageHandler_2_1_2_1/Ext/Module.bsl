...
//  MessageProcessed - Boolean, a flag showing that the message is successfully processed. The value of this parameter
//     shall be set as equal to True, if the message was successfully read in this handler
//
...
Function SettingsGettingOperationRepresentation()
	...
	Return NStr("en = 'Receiving settings of data synchronization from the service manager.'");
	
EndFunction

Function SynchronizationEnablingRepresentation()
	
	Return NStr("en = 'Enable data synchronization in the service manager.'");
	
EndFunction

Function SynchronizationDisablingRepresentation()
	
	Return NStr("en = 'Disable data synchronization in the service manager.'");
	
EndFunction

Function SynchronizationPerformingRepresentation()
	
	Return NStr("en = 'Synchronize data on user request.'");
