...
Function RepresentationSynchronizationSettingStep1()
	...
	Return NStr("en = 'Data synchronization, step 1.'");
	
EndFunction

Function RepresentationSynchronizationSettingStep2()
	
	Return NStr("en = 'Data synchronization, step 2.'");
	
EndFunction

Function RepresentationExchangeMessageImporting()
	
	Return NStr("en = 'Import exchange message.'");
	
EndFunction

Function RepresentationCorrespondentDataGetting()
	
	Return NStr("en = 'Receiving correspondent data.'");
	
EndFunction

Function RepresentationCorrespondentNodesCommonDataGetting()
	
	Return NStr("en = 'Receiving common data of node of a correspondent.'");
	
EndFunction

Function RepresentationCorrespondentAccountingParametersGetting()
	
	Return NStr("en = 'Receiving accounting parameters of the correspondent'");
