...
// Objects parameter for those metadata objects for which the ref to the company is located in the attribute with a name
// which is different from the standard name "Company".
//
// Parameters:
//  Objects - ValuesTable.
