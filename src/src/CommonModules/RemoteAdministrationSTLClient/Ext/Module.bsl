...
//    server agent via COM-connection or administer server with the query of connection parameters to the cluster of the
//    current user). May be set to the False value inside the event processor, in
