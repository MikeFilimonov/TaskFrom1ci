////////////////////////////////////////////////////////////////////////////////
// Subsystem "Report options" (server, perf. perf.).
// 
...
// Generates the list of configuration report options that are not available for the current user by functional options.
//
// Returns:
//   Array of CatalogRef.PredefinedReportsVariants -
//       Report options that are disabled by the functional options.
//
// Description:
//   This array should be used in all queries
...
Function DisabledApplicationOptions() Export
	...
	ConstantValue = Constants.ReportOptionParameters.Get();
...
// Returns True if a user has a right to read the options of reports.
Function ReadRight() Export
	Return AccessRight("Read", Metadata.Catalogs.ReportsVariants);
EndFunction

// Returns True if a user has a right to save the options of reports.
