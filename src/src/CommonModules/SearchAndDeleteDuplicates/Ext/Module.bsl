...
//                              For example, Catalog.Products. Search in the
...
//                              be analysed, replacement was not implemented ReplacementDenied   - the
//                              ItemsReplacePossibility method returned a denial.
