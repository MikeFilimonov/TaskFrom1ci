...
Procedure CombineSelected(Val CombinedItems) Export
	...
	OpenForm("DataProcessor.ReplaceAndMergeItems.Form.CombineElements", FormParameters); 
...
Procedure ReplaceSelected(Val ReplacedItems) Export
	...
	OpenForm("DataProcessor.ReplaceAndMergeItems.Form.ReplacementElements", FormParameters); 
