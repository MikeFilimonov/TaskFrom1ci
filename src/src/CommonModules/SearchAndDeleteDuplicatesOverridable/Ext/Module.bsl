...
// Get objects which have an opportunity to parameter the duplicates search algorithm in manager modules using the
// DuplicatesSearchParameters, OnSearchDuplicates and ItemsChangePossibility export procedures.
//
// Parameters:
