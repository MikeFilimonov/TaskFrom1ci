...
#Region IntegrationWithObjectAttributeNoEditOrderSubsystem
...
#Region IntegrationWithObjectGroupChangingSubsystem
...
Procedure WhenDefiningObjectsWithEditableAttributes(Objects) Export
	...
	If CommonUse.SubsystemExists("StandardSubsystems.Currencies") Then
		ModuleContactInformationManagementService = CommonUse.CommonModule("WorkWithExchangeRates");
		ModuleContactInformationManagementService.WhenDefiningObjectsWithEditableAttributes(Objects);
	EndIf;
...
#Region IntegrationWithDataImportingFromFileSubsystem
...
Procedure OnDetermineCatalogsForDataImport(ImportedCatalogs) Export
	...
	If CommonUse.SubsystemExists("StandardSubsystems.Currencies") Then
		...
		ModuleWorkWithExchangeRates.OnDetermineCatalogsForDataImport(ImportedCatalogs);
	EndIf;
