...
// If the WordSeparators parameter is not specified, the words separator is any character that does not belong to Latin
// characters, Cyrillic characters, digits, underscores.
//
// Parameters:
...
Function StringWithNumberForAnyLanguage(Template, Number, Type = Undefined, FormatString = Undefined) Export
	...
	If Type = Undefined Then
		Type = NumericValueType.Cardinal;
	EndIf;

	Return StringWithNumber(Template, Number, Type, FormatString);
