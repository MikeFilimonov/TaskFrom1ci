			...
			For Each FieldName In ControlRule.Value Do
				...
				Else
					...
					Raise StringFunctionsClientServer.SubstituteParametersInString(
						NStr("en = 'Metadata object %1 is not supported.'"), MetadataObject.FullName());
...
//               Remaining columns of equal fields of natural object key that were passed to the
...
Procedure RaiseExceptionFailedDefineField(Val FieldName, Val ObjectName)
	...
	Raise StringFunctionsClientServer.SubstituteParametersInString(
		NStr("en = 'Cannot build request to receive %1 field value of metadata object %2.'"),
