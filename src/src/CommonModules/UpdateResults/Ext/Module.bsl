...
//                                                 the non-exclusive mode during the handler start. IN this case, the
//                                                 handler should not make any changes in IB.
...
#Region ProceduresAndFunctionsForUseInTheUpdateHandlers
//
