...
Procedure RefreshGeneralParameters(HasChanges = Undefined, CheckOnly = False) Export
	...
	Try
		...
		StandardSubsystemsServer.ConfirmUpdatingApplicationWorkParameter(
			"UserSessionParameters", "UnavailableRolesByUserTypes");
...
Function InaccessibleRightsByTypesUsers()
	...
	Rights.Insert("Administration",                     NStr("en = 'Administration'"));
	Rights.Insert("UpdateDataBaseConfiguration",      NStr("en = 'Update infobase configuration'"));
	...
	Rights.Insert("InteractiveOpenExtDataProcessors", NStr("en = 'Interactive opening of external data processors'"));
	Rights.Insert("InteractiveOpenExtReports",   NStr("en = 'Interactive opening of external reports'"));
