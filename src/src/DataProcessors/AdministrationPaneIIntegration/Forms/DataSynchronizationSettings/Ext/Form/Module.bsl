...
Procedure SetEnabled(AttributePathToData = "")
	...
	If AttributePathToData = "ConstantsSet.UseDataSync" OR AttributePathToData = "" Then
		...
		CommonUseClientServer.SetFormItemProperty(Items, "ResultsSynchronizationData", 					"Enabled", ConstantsSet.UseDataSync);
		CommonUseClientServer.SetFormItemProperty(Items, "GroupDistributedInfobaseNodePrefix",	"Enabled", ConstantsSet.UseDataSync);
		CommonUseClientServer.SetFormItemProperty(Items, "DataSynchronizationSettings",						"Enabled", ConstantsSet.UseDataSync);
		CommonUseClientServer.SetFormItemProperty(Items, "ResultsSynchronizationData",						"Enabled", ConstantsSet.UseDataSync);
		CommonUseClientServer.SetFormItemProperty(Items, "GroupTemporaryDirectoriesServersCluster",			"Enabled", ConstantsSet.UseDataSync);
