...
//     - for delimiter-space empty lines are not included in the result, for other delimiters empty lines are included
//     in the result. E if Line parameter does not contain significant characters or doesn't contain any symbol (empty line),
