...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(InfobaseNode) Then
		...
		Else
			DataExchangeServer.ShowMessageAboutError(NStr("en = 'Form parameters are not specified. Cannot open the form.'"), Cancel);
			Return;
		EndIf;
