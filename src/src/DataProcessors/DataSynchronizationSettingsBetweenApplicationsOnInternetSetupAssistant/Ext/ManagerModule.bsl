...
Procedure RunAutomaticDataMapping(Parameters, TemporaryStorageAddress) Export
	...
	If Cancel Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Errors occurred while receiving an exchange message from the external resource for the ""%1"" correspondent.'"),
	...
	If Cancel Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Errors occurred while analyzing exchange message for the ""%1"" correspondent.'"),
			String(Correspondent));
	EndIf;
	...
	If Cancel Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Errors occurred while automatically mapping data received from the ""%1"" correspondent.'"),
			String(Correspondent));
	EndIf;
...
Procedure GetStatsComparison(Parameters, TemporaryStorageAddress) Export
	...
	If Cancel Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en = 'Errors occurred while receiving statistics information for the ""%1"" correspondent.'"),
