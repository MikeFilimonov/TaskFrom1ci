...
Procedure Initialization() Export
	...
	mBodyMessageIsCompressed	= NStr("en = 'Compressed data exchange message'");
	mBodyMessageIsBatched	= NStr("en = 'Package message of the data exchange'");
...
Function GetExchangeMessage()
	...
	If ExchangeMessageTable.Count() = 0 Then
		...
		MessageString = NStr("en = 'Emails with title ""%1"" are not found'");
...
Procedure ErrorMessagesInitialization()
	...
	// Common error codes
	ErrorMessages.Insert(001, NStr("en = 'Exchange emails are not found.'"));
	ErrorMessages.Insert(002, NStr("en = 'An error occurred when unpacking a compressed message file.'"));
	ErrorMessages.Insert(003, NStr("en = 'An error occurred when compressing the exchange message file.'"));
	ErrorMessages.Insert(004, NStr("en = 'Error when creating temporary directory.'"));
	ErrorMessages.Insert(005, NStr("en = 'Archive does not include exchange message file.'"));
	ErrorMessages.Insert(006, NStr("en = 'Exchange message was not sent: allowed message size exceeded.'"));
	
	// Errors codes, that are dependent on the transport kind.
	ErrorMessages.Insert(101, NStr("en = 'Initialization error: email account of the exchange message transport is not specified.'"));
	ErrorMessages.Insert(102, NStr("en = 'An error occurred when sending the email.'"));
	ErrorMessages.Insert(103, NStr("en = 'An error occurred when getting message titles from the email server.'"));
	ErrorMessages.Insert(104, NStr("en = 'Exchange emails are not found on email server.'"));
	ErrorMessages.Insert(105, NStr("en = 'An error occurred when receiving a message from the email server.'"));
	ErrorMessages.Insert(106, NStr("en = 'An error occurred when writing the exchange message file to the disk.'"));
	ErrorMessages.Insert(107, NStr("en = 'Account parameter check is completed with errors.'"));
	ErrorMessages.Insert(108, NStr("en = 'Exchange message size exceeds the allowable limit.'"));
	ErrorMessages.Insert(109, NStr("en = 'Error: a file with message is not found in the mail message.'"));
	
EndProcedure

#EndRegion

#Region WorkingWithEMail
