...
Function GetExchangeMessage()
	...
	If ExchangeMessageFileTable.Count() = 0 Then
		...
		MessageString = NStr("en = 'Data exchange directory on server: ""%1""'");
...
Procedure ErrorMessagesInitialization()
	...
	// Common error codes
	ErrorMessages.Insert(001, NStr("en = 'Information exchange directory does not contain a message file with data.'"));
	...
	ErrorMessages.Insert(004, NStr("en = 'An error occurred when creating a temporary directory.'"));
	...
	ErrorMessages.Insert(102, NStr("en = 'An error occurred when initializing connection to the FTP server.'"));
	ErrorMessages.Insert(103, NStr("en = 'An error occurred when connecting to the FTP server, check the path correctness and access rights to the resource.'"));
	ErrorMessages.Insert(104, NStr("en = 'An error occurred when searching for files on FTP server.'"));
	ErrorMessages.Insert(105, NStr("en = 'An error occurred when receiving the file from FTP server.'"));
	ErrorMessages.Insert(106, NStr("en = 'An error occurred when removing file on FTP server, check access rights to the resource.'"));
