...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not DataExchangeSaaSReUse.DataSynchronizationSupported() Then
		ErrorText = NStr("en = 'Data synchronization for this configuration is not supported.'");
		
	ElsIf Not Parameters.Property("InfobaseNode", Object.InfobaseNode) Then
		ErrorText = NStr("en = 'Data processor is not intended for direct usage.'");
		
	ElsIf Object.InfobaseNode.IsEmpty() Then
		ErrorText = NStr("en = 'Data exchange setting is not found.'");
...
Procedure BeforeClose(Cancel, Exit, WarningText, StandardProcessing)
	...
	CommonUseClient.ShowArbitraryFormClosingConfirmation(
		ThisObject, Cancel, Exit, ConfirmationText, "ForceCloseForm");
...
//      the current number of the NavigationPageName step                - String - The NavigationPanel panel page name
//      that matches to the current number of the DecorationPageName step                - String - The DecorationPanel
//      panel page name that matches to the current number of the OnOpenHandlerName step           - String - Function
//      handler name of the opening event of the GoNextHandlerName current assistant page      - String - Function
//      handler name of the going event to the GoBackHandlerName next assistant page      - String - Function handler
//      name of the going event to previous page of the LongAction assistant                  - Boolean - Shows
//      displayed long operation page. False - show normal page.
...
Procedure GoToTableNewRow(GoToNumber, MainPageName, NavigationPageName, 
	...
	LongAction = False, LongOperationHandlerName = "")
...
Procedure CorrespondentIdleHandler()
	...
	Else
		LongOperationState.ErrorInfo = NStr("en = 'Correspondent notification error'");
...
Function BackgroundJobDumpsAtServer()
	...
	Task = BackgroundJobs.Execute("DataExchangeSaaS.ExchangeOnDemand", 
		BackgroundExecutionParameters, , NStr("en = 'Interactive exchange on request.'"));
