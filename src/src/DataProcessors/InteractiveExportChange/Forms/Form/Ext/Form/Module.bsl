...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(Object.InfobaseNode) Then
		Text = NStr("en = 'Data exchange setting is not found.'");
...
Procedure AdditionalRegistrationBeforeDeleting(Item, Cancel)
	...
	If Quantity>1 Then
		PresentationText = NStr("en = 'Selected lines'");
...
Function QuantityUpdated()
	...
	BackgroundJobResult = LongActions.ExecuteInBackground(UUID,
		...
		JobParameters, NStr("en = 'Calculating the number of objects to be sent during synchronization'"));
