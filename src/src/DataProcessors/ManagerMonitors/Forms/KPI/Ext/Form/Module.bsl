...
Procedure RefreshData()
	...
	|			Month,
	|			Company = &Company
	|				AND GLAccount.TypeOfAccount = VALUE(Enum.GLAccountsTypes.Revenue)) AS AccountingIncomeAndCosts
	|
	|UNION ALL
	|
	|SELECT
	...
	|			Month,
	|			Company = &Company
	|				AND GLAccount.TypeOfAccount = VALUE(Enum.GLAccountsTypes.CostOfSales)) AS AccountingIncomeAndCosts
	|
	|UNION ALL
	|
	|SELECT
