...
Function ExportInXMLString(OfflineWorkplacePrefix, Val DateOfInitialImage, OfflineWorkplace)
	...
	WriteXML(XMLWriter, ApplicationTitle(),              "ApplicationTitle", XMLTypeAssignment.Explicit);
...
Function GenerateApplicationNameInService()
	...
	Result = StrReplace(Result, "[Explanation]", NStr("en = 'online application'"));
...
Function ApplicationTitle()
	...
	Return ?(IsBlankString(Result), NStr("en = 'Offline work place'"), Result);
EndFunction
