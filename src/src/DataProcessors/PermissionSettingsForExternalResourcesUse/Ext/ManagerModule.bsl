...
//    corresponds to the external module information on which granted permissions it is required to clear. If the
//    parameter value is not set - information about granted permissions will be blocked by all external modules.
...
//    clear. If the parameter value is not set - information on all provided permissions for all external modules will
//    be cleared.
