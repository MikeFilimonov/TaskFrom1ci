...
Function NewSecurityProfileDescription(Val SoftwareModuleType, Val SoftwareModuleID) Export
	...
	If IsBlankString(InfobaseName) Then
		Raise NStr("en = 'Infobase connection string does not contain the name of the infobase.'");
	EndIf;
...
Function Semaphore()
	...
	SemaphoreKey = New Structure();
	SemaphoreKey.Insert("IDRequest", New UUID("8e02fbd3-3f9f-4c3c-964d-7c602ad4eb38"));
	
	Return InformationRegisters.PermissionQueriesOnUseExternalResources.CreateRecordKey(SemaphoreKey);
