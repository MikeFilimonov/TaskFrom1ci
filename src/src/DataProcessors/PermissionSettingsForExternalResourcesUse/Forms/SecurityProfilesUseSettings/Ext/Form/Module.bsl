...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not WorkInSafeModeService.SecurityProfilesCanBeUsed() Then
		Raise NStr("en = 'Use of security profiles is not available for this configuration.'");
	EndIf;
	
	If Not WorkInSafeModeService.SecurityProfilesSetupAvailable() Then
		Raise NStr("en = 'Setting of security profiles is not available.'");
	EndIf;
...
Procedure StartUseSecurityProfilesUseSettings(Val UUID)
	...
	If Not WorkInSafeModeService.SecurityProfilesCanBeUsed() Then
		Raise NStr("en = 'Enabling automatic permission request is not available.'");
	EndIf;
