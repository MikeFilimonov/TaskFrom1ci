...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If BaseFile Then
		TemplateOrderUpdate = DataProcessors.PlatformUpdateTip.GetTemplate("FileBaseUpdateOrder");
	Else
		TemplateOrderUpdate = DataProcessors.PlatformUpdateTip.GetTemplate("ClientServerBaseUpdateOrder");
	EndIf;
