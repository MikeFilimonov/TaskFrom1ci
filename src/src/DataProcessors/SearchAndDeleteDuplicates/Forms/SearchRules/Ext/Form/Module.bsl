...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = StrReplace( NStr("en = 'Rules of searching for duplicates ""%1""'"), "%1", Parameters.SelectionAreaPresentation);
...
Function SelectionErrors() 
	...
	Return NStr("en = 'Specify at least one rule for duplicate search.'");
EndFunction
