...
Function InitializeDataToSetupStandardODataInterface() Export
	...
	AddTreeRootString("DocumentJournal", NStr("en = 'Document logs'"), 4, PictureLib.DocumentJournal);
	AddTreeRootString("Enum", NStr("en = 'Enum'"), 5, PictureLib.Enum);
	AddTreeRootString("ChartOfCharacteristicTypes", NStr("en = 'Charts of characteristic types'"), 6, PictureLib.ChartOfCharacteristicTypes);
	...
	For Each ModelItem In Model Do
		...
		SubordinateDocumentStructure = ModelItem.SubordinateDocumentStructure;
		...
		If CommonUseSTL.MetadataObjectAvailableByFunctionalOptions(DescriptionFull) Then
			...
			AddTreeSubstring(DescriptionFull, ThisIsReadOnlyObject,
				ThisIsObjectIncludedInContent, SubordinateDocumentStructure);
...
Procedure AddTreeSubstring(Val DescriptionFull, Val ReadOnly, Val Use, Val SubordinateDocumentStructure)
	...
	For Each ObjectDependence In SubordinateDocumentStructure Do
