...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	AddTreeRootString(Tree, "DocumentJournal", NStr("en = 'Document logs'"), 4, PictureLib.DocumentJournal);
	AddTreeRootString(Tree, "Enum", NStr("en = 'Enum'"), 5, PictureLib.Enum);
	AddTreeRootString(Tree, "ChartOfCharacteristicTypes", NStr("en = 'Charts of characteristic types'"), 6, PictureLib.ChartOfCharacteristicTypes);
