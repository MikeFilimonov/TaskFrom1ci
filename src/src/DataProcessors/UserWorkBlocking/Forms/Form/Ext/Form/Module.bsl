...
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
	...
	InformationAboutLockingSessions = InfobaseConnections.InformationAboutLockingSessions(NStr("en = 'Not locked.'"));
	...
	If Object.LockBegin > Object.LockEnding 
		...
		CommonUseClientServer.MessageToUser(
			NStr("en = 'Lock end date cannot be earlier than lock start date. Lock is not set.'"),,
	...
	If Not ValueIsFilled(Object.LockBegin) Then
		CommonUseClientServer.MessageToUser(
			NStr("en = 'Lock start date is not specified.'"),,	"Object.LockBegin",,Cancel);
		Return;
	EndIf;
...
Procedure Apply(Command)
	...
	If Object.ProhibitUserWorkTemporarily Then
		...
		QuestionTitle = NStr("en = 'User operation locking'");
...
Procedure SetConditionalAppearance()
	...
	FilterElement.LeftValue = New DataCompositionField("UsersWorkProhibitionStatus");
	FilterElement.ComparisonType = DataCompositionComparisonType.Equal;
	FilterElement.RightValue = NStr("en = 'Expired'");
...
Procedure RefreshSettingsPage()
	...
	Items.DisableScheduledJobs.Title = ?(Object.DisableScheduledJobs,
		NStr("en = 'Keep locking operations of scheduled jobs'"), NStr("en = 'Also disable scheduled jobs'"));
...
Procedure InstallStarterStatusBanUsers()
	...
	If Object.ProhibitUserWorkTemporarily Then
		If CurrentSessionDate() < Object.LockBegin Then
			InitialUserWorkProhibitionState = NStr("en = 'User operation in the application will be prohibited at the specified time'");
			UsersWorkProhibitionStatus = "Planned";
		ElsIf CurrentSessionDate() > Object.LockEnding AND Object.LockEnding <> '00010101' Then
			InitialUserWorkProhibitionState = NStr("en = 'User operation in the application is allowed (prohibition period has ended)'");;
			UsersWorkProhibitionStatus = "Timed Out";
		Else
			InitialUserWorkProhibitionState = NStr("en = 'User operation in the application is prohibited'");
			UsersWorkProhibitionStatus = "Prohibited";
		EndIf;
	Else
		InitialUserWorkProhibitionState = NStr("en = 'User operation in the application is allowed'");
...
Procedure AfterAdministrationParametersGettingOnBlocking(Result, AdditionalParameters) Export
	...
	ShowUserNotification(NStr("en = 'User operation locking'"),
