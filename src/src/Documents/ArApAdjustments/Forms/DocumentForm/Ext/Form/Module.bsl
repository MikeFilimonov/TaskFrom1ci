...
Procedure SetVisibleAndEnabled()
	...
	If Object.OperationKind = PredefinedValue("Enum.OperationTypesArApAdjustments.ArApAdjustments") Then
		...
		Items.CounterpartySource.Title = Nstr("en = 'Debtor'");
		Items.CounterpartyRecipient.Title =  Nstr("en = 'Creditor'");
	...
	ElsIf Object.OperationKind = PredefinedValue("Enum.OperationTypesArApAdjustments.CustomerDebtAssignment") Then
		...
		Items.CounterpartyRecipient.Visible = True;
		Items.CounterpartySource.Title = Nstr("en = 'Debtor'");
		Items.CounterpartyRecipient.Title =  Nstr("en = 'Assignee'");
		Items.Pages.PagesRepresentation = FormPagesRepresentation.TabsOnTop;
	...
	ElsIf Object.OperationKind = PredefinedValue("Enum.OperationTypesArApAdjustments.DebtAssignmentToVendor") Then
		...
		Items.CounterpartySource.Visible = True;
		Items.CounterpartyRecipient.Visible = True;
		Items.CounterpartySource.Title =  Nstr("en = 'Creditor'");
		Items.CounterpartyRecipient.Title =  Nstr("en = 'Assignee'");
		Items.Pages.PagesRepresentation = FormPagesRepresentation.TabsOnTop;
...
Procedure PickAccountsReceivable(Command)
	...
	If Not ValueIsFilled(Object.CounterpartySource) Then
		ShowMessageBox(, NStr("en = 'Please select a customer.'"));
		Return;
	EndIf;
	...
	OpenForm("CommonForm.SelectCustomersDocument", SelectionParameters,,,,, New NotifyDescription("PickUpPaymantsToCustomerEnd", ThisObject, New Structure("AddressDebitorInStorage", AddressDebitorInStorage)));
...
Procedure PickVendorSettlements(Command)
	...
	If Not ValueIsFilled(Object.Counterparty) Then
		ShowMessageBox(, NStr("en = 'Please select a supplier.'"));
		Return;
	EndIf;
	...
	SelectionParameters = New Structure(
		...
		Company,
		Object.Date,
		?(Object.OperationKind = PredefinedValue("Enum.OperationTypesArApAdjustments.DebtAssignmentToVendor"), Object.CounterpartySource, Object.Counterparty),
		Object.Ref
	);
	...
	OpenForm("CommonForm.SelectSuppliersDocument", SelectionParameters,,,,, New NotifyDescription("PickVendorSettlementsEnd", ThisObject, New Structure("AddressCreditorInStorage", AddressCreditorInStorage)));
...
Procedure FillByDocumentBase(Command)
	...
	If Not ValueIsFilled(Object.BasisDocument) Then
		...
		Message.Text		= NStr("en = 'Please select a base document.'");
	...
	QuestionText 	= NStr("en = 'Do you want to refill AR/AP adjustments?'");
	Response = Undefined;
