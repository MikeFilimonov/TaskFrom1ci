...
Procedure Pick(Command)
	...
	DocumentPresentaion	= NStr("en = 'intra-warehouse transfer'");
...
Procedure FillByBasis(Command)
	...
	ShowQueryBox(New NotifyDescription("FillByBasisEnd", ThisObject), NStr("en = 'Do you want to refill the intrawarehouse transfer?'"), QuestionDialogMode.YesNo, 0);
