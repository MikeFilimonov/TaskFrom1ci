...
Procedure ExpensesCounterpartyStartChoice(Item, ChoiceData, StandardProcessing)
	...
	CurrentData = Items.Expenses.CurrentData;
	If CurrentData.TypeOfAccount <> PredefinedValue("Enum.GLAccountsTypes.AccountsPayable") AND CurrentData.TypeOfAccount <> PredefinedValue("Enum.GLAccountsTypes.AccountsReceivable") Then
		StandardProcessing = False;
		Message = New UserMessage;
		Message.Text = NStr("en = 'For this type of account, you do not need to specify a counterparty'");
		Message.Message();
	EndIf;
...
Procedure ExpensesContractStartChoice(Item, ChoiceData, StandardProcessing)
	...
	If TablePartRow.TypeOfAccount <> PredefinedValue("Enum.GLAccountsTypes.AccountsPayable") AND TablePartRow.TypeOfAccount <> PredefinedValue("Enum.GLAccountsTypes.AccountsReceivable") Then
		
		StandardProcessing = False;
		Message = New UserMessage;
		Message.Text = NStr("en = 'For this type of account, you do not need to specify a contract'");
		Message.Message();
...
Procedure FormManagement(Form)
	...
	If Object.OtherSettlementsAccounting AND (Form.TypeOfAccount = PredefinedValue("Enum.GLAccountsTypes.AccountsReceivable")
