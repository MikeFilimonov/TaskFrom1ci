...
Procedure FillByPlan(Command)
	...
	If Not ValueIsFilled(Object.Company) Then
		...
		Message.Text = NStr("en = 'Company is not populated. Population is canceled.'");
	...
	If Not ValueIsFilled(Object.StructuralUnit) Then
        Message = New UserMessage();
		Message.Text = NStr("en = 'Department is not populated. Population is canceled.'");
	...
	If Not ValueIsFilled(Object.Employee) Then
        Message = New UserMessage();
		Message.Text = NStr("en = 'Employee is not selected. Population is canceled.'");
	...
	If Not ValueIsFilled(Object.DateFrom) Then
        Message = New UserMessage();
		Message.Text = NStr("en = 'Week start is not selected. Population is canceled.'");
	...
	If Not ValueIsFilled(Object.DateTo) Then
        Message = New UserMessage();
		Message.Text = NStr("en = 'Week end is not selected. Population is canceled.'");
...
Procedure BeforeWrite(Cancel, WriteParameters)
	...
	PerformanceEstimationClientServer.StartTimeMeasurement("DocumentWeeklyTimesheetPosting");
	// StandardSubsystems.PerformanceMeasurement
