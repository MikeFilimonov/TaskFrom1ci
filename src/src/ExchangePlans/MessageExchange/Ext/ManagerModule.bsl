...
// Applied developer based on set filters on the node should generate a row of restrictions description convenient for a
// user.
// 
// Parameters:
...
// Structure of the settings repeats the content of header attributes and tabular sections of an exchange plan of a
// correspondent base; Structure items similar in key and value are used for
// header attributes. Structures containing arrays of
// tabular sections values of exchange plan parts are used for tabular sections.
// 
// Parameters:
...
//                                       of the exchange plan of a correspondent base received using the
//                                       FiltersSettingOnCorrespondentBaseNode() function.
// CorrespondentVersion - String - Correspondent version number. It is used
// 								for example for different restriction description of data transfer depending on correspondent version.
// 
// Returns:
...
//                                       node of the correspondent base received using the
//                                       DefaultValuesOnCorrespondentBaseNode() function.
// CorrespondentVersion - String - Correspondent version number. It is used
// 								for example for different value description default depending on correspondent version.
// 
// Returns:
...
// correspondent version and if an exchange setting is not supported by a correspondent of a specified version, then
// call an exception.
//
//  Parameters:
...
#Region ConstantsAndCheckingOfAccountingParameters
