...
Function NewQueryUpdateDataRegister(RefOfMetadataObjects)
	...
	Query.SetParameter("ObjectFillingKind",         Enums.AdditionalReportsAndDataProcessorsTypes.ObjectFill);
	Query.SetParameter("ReportKind",                     Enums.AdditionalReportsAndDataProcessorsTypes.Report);
	Query.SetParameter("KindPrintForm",             Enums.AdditionalReportsAndDataProcessorsTypes.PrintForm);
	Query.SetParameter("KindLinkedObjectsCreation", Enums.AdditionalReportsAndDataProcessorsTypes.CreatingLinkedObjects);
