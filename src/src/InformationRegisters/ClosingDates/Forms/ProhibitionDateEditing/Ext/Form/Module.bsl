...
////////////////////////////////////////////////////////////////////////////////
// Same event handlers of forms ClosingDates and ProhibitionDateEditing.
...
////////////////////////////////////////////////////////////////////////////////
// Same procedure and function of forms ClosingDates and ProhibitionDateEditing.
	...
	Else
		...
		If Context.AllowDataChangingToProhibitionDate Then
			...
			Else
				...
				EndIf;
				LabelText = Chars.LF
				             + NStr("en = 'For %2 data might change from %3 to %4'")
				             + Chars.LF
				             + NStr("en = 'After %2 it will be prohibited to change %4 data'")
				             + Chars.LF;
			EndIf;
		Else
			Context.Items.PropertyPermissionDaysCountChanges.CurrentPage =
