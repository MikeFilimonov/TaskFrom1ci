...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not CommonUseClientServer.ThisIsWebClient() AND TemplateType = "MXL" Then
		Items.DoesLabelChangesNotWebClient.Title = NStr("en = 'After you make changes in the template, click ""End editing""'");
	EndIf;
...
Procedure SetApplicationNameForTemplateOpening()
	...
	If FileType = "mxl" Then
		ApplicationNameForOpeningTemplate = NStr("en = '1C:Enterprise - File operations'");
	...
	InfoForFilling.Insert("ActionsDetails", ?(Parameters.OnlyOpening, NStr("en = 'openings'"), NStr("en = 'make changes'")));
