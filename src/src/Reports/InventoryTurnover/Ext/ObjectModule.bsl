...
Function GenerateTableParameter(Table)
	...
	TypeDescription = New TypeDescription(Array, ,);
	Array.Clear();
	TableParameter.Columns.Add("Products", TypeDescription);
	...
	Array.Add(Type("CatalogRef.ProductsBatches"));
	TypeDescription = New TypeDescription(Array, ,);
	Array.Clear();
	...
	Array.Add(Type("CatalogRef.BusinessUnits"));
	TypeDescription = New TypeDescription(Array, ,);
	Array.Clear();
...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	AddSelectedFieldDCS(Group, "Products");
	...
	While SelectionCompany.Next() Do
		...
		While SelectionStructuralUnit.Next() Do
			...
			While SelectionGlAccount.Next() Do
				SelectionProducts = SelectionGlAccount.Select(QueryResultIteration.ByGroups, "Products");
