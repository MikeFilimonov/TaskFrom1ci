...
Procedure ConfigureReportsVariants(Settings, ReportSettings) Export
	...
	VariantSettings = ModuleReportsVariants.VariantDesc(Settings, ReportSettings, "UserDetailsAndExternalUsers");
	...
	VariantSettings = ModuleReportsVariants.VariantDesc(Settings, ReportSettings, "UserDetails");
	VariantSettings.Description = 
		NStr("en = 'Displays detailed information
...
Procedure FormGetProcessing(FormKind, Parameters, SelectedForm, AdditionalInformation, StandardProcessing)
	...
	If Not Parameters.Property("VariantKey") Then
		...
		Parameters.Insert("VariantKey", "UserDetailsAndExternalUsers");
		SelectedForm = "Report.UserDetails.Form";
	EndIf;
