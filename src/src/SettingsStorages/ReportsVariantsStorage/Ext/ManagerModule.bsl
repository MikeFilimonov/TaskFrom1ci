...
//       - Undefined - Delete all report options.
//       - String       - Report option key.
...
// Report option setting reading handler.
//
// Parameters:
//   ReportKey        - String - Full report name with a dot.
...
//       It is not used so subsystem "Report options" does not divide by authors.
...
// Report option setting record handler.
//
// Parameters:
//   ReportKey        - String - Full report name with a dot.
//   VariantKey      - String - Report option key.
...
// Report option setting description receive handler.
//
// Parameters:
//   ReportKey       - String - Full report name with a dot.
//   VariantKey     - String - Report option key.
...
// Report option setting description set handler.
//
// Parameters:
//   ReportKey       - String - Full report name with a dot.
//   VariantKey     - String - Report option key.
